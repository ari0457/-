    ...
    public partial class BookingWindow : Window
    {
        ...
        public BookingWindow(List<Room> rooms, Booking booking = null)
        {
            ...
            if (booking != null)
            {
                ...
                GuestPhoneBox.Text = booking.GuestPhone;
                StartDatePicker.SelectedDate = booking.StartDate;
                EndDatePicker.SelectedDate = booking.EndDate;
                RoomCombo.SelectedIndex = availableRooms.FindIndex(r => r.Number == booking.RoomNumber);
            }
            else
            {
        ...
        private void RecalcPrice()
        {
            ...
            {
                int nights = (EndDatePicker.SelectedDate.Value - StartDatePicker.SelectedDate.Value).Days;
        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            GuestPhone = GuestPhoneBox.Text.Trim();
            StartDate = start;
            EndDate = end;
            RecalcPrice();
